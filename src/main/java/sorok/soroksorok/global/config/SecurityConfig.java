...
import sorok.soroksorok.global.login.CustomJsonUsernamePasswordAuthenticationFilter;
import sorok.soroksorok.global.login.LoginFailureHandler;
import sorok.soroksorok.global.login.LoginService;
import sorok.soroksorok.global.login.LoginSuccessHandler;
...
public class SecurityConfig {
  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    http
        ...
        .antMatchers(HttpMethod.POST, "/api/auth/**").permitAll() // 회원가입 접근 가능
        .antMatchers(HttpMethod.GET, "/api/**").permitAll() // 회원가입 접근 가능
        .antMatchers("/v3/api-docs/**", "/swagger-ui/**", "/swagger-resources/**").permitAll() // 회원가입 접근 가능
